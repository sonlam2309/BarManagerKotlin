...
class DrinkOutOfStockActivity : BaseActivity() {
    ...
    private fun initToolbar() {
        if (supportActionBar != null) {
            supportActionBar!!.title = getString(R.string.feature_drink_out_of_stock)
    ...
    private fun initUi() {
        ...
        edtSearchName?.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                if (strKey == "" || strKey.isEmpty()) {
                    mKeySeach = ""
                    getListDrink()
                    GlobalFuntion.hideSoftKeyboard(this@DrinkOutOfStockActivity)
                }
            }
        })
        ...
        mManageDrinkAdapter = ManageDrinkAdapter(mListDrink, object : ManageDrinkAdapter.IManagerDrinkListener {
            override fun clickItem(drink: Drink?) {
                GlobalFuntion.goToDrinkDetailActivity(this@DrinkOutOfStockActivity, drink)
            }
        })
